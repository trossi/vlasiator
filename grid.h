 ...
 */
bool adaptRefinement(dccrg::Dccrg<SpatialCell,dccrg::Cartesian_Geometry>& mpiGrid, TechnicalFsGrid & technicalGrid, SysBoundary& sysBoundaries, Project& project, bool useStatic = false);
